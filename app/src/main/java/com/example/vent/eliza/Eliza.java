...
package com.example.vent.eliza;
...
public class Eliza {
    Context context;
    public Eliza(Context ontext) throws IOException {
        context = ontext;
		readDefaultScript();
    }
	...
	public int readDefaultScript() throws IOException {
		clearScript();
		


        InputStream s = context.getResources().getAssets().open("eliza.script");
